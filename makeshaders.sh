...
STARA_SHADERS="
	staraBlueShader:0:gfx/effects/starblue:GFX_BLUE
	staraCyanShader:0:gfx/effects/starcyan:GFX_CYAN
	staraGreenShader:0:gfx/effects/stargreen:GFX_GREEN
	staraRedShader:0:gfx/effects/starred:GFX_RED
	staraTealShader:0:gfx/effects/starteal:GFX_TEAL
	staraYellowShader:0:gfx/effects/staryellow:GFX_YELLOW
"
makeShader "$STARA_SHADERS" staraShaderSkel CHAM_STARA
...
STARB_SHADERS="
	starbBlueShader:0:gfx/effects/starblue:GFX_BLUE
	starbCyanShader:0:gfx/effects/starcyan:GFX_CYAN
	starbGreenShader:0:gfx/effects/stargreen:GFX_GREEN
	starbRedShader:0:gfx/effects/starred:GFX_RED
	starbTealShader:0:gfx/effects/starteal:GFX_TEAL
	starbYellowShader:0:gfx/effects/staryellow:GFX_YELLOW
"
makeShader "$STARB_SHADERS" starbShaderSkel CHAM_STARB
