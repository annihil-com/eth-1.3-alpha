...
void initUserVars() {
	...
	seth.vars[VAR_TARGET_PRIO] = (ethVars_t) { "Target priority", TARGET_NEAREST, "targetprio", CAT_AIMBOT, qfalse,
	...
	seth.vars[VAR_HITBOX] = (ethVars_t) { "Hitbox Correction", HITBOX_ETMAIN, "hitbox", CAT_AIMBOT, qfalse,
		{ { "Off", HITBOX_OFF },{ "ETmain", HITBOX_ETMAIN }, { "ETpro", HITBOX_ETPRO }, { "ETpub unfixed", HITBOX_ETPUB_UNFIXED }, { "ETpub fixed", HITBOX_ETPUB_REALHEAD }, { "realhead", HITBOX_GENERAL }} };
	...
	seth.vars[VAR_VECZ_SCOPE] = (ethVars_t) { "Scoped weapons vecZ", 3.0f, "vecz_scope", CAT_AIMBOT, qfalse,
		{} };
        seth.vars[VAR_SNAPDELAY] = (ethVars_t) { "SNAP DELAY", 1 ,"snapdelay", CAT_AIMBOT, qfalse, 
		{} };
	...
	seth.vars[VAR_AIMPREDICT] = (ethVars_t) { "Enemy prediction type", AIMPREDICT_AUTO_1, "epredict", CAT_AIMBOT, qfalse,
		{ { "Off", AIMPREDICT_OFF }, { "Auto 1", AIMPREDICT_AUTO_1 }, { "Auto 2", AIMPREDICT_AUTO_2 }, { "Ping based", AIMPREDICT_AUTO_3 }, { "Snapshot based", AIMPREDICT_SNAPSHOT } } };
	seth.vars[VAR_SELFPREDICT] = (ethVars_t) { "Self prediction type", qtrue, "spredict", CAT_AIMBOT, qfalse,
		{ { "Off", qfalse }, { "On", qtrue } } };
	seth.vars[VAR_SNIPERDELAY] = (ethVars_t) { "Sniper weapon delay", 700, "sniperdelay", CAT_AIMBOT, qfalse,
		{} };
	seth.vars[VAR_OVERHEAT] = (ethVars_t) { "Anti weapon overheat", qtrue, "overheat", CAT_AIMBOT, qfalse,
		{ { "Off", qfalse }, { "On", qtrue } } };
	seth.vars[VAR_RECOIL] = (ethVars_t) { "Recoil and Feedback", 2, "recoil", CAT_AIMBOT, qfalse,
		{ { "Off", 0 }, { "On (detour)", 1 }, { "On (EntityEvent)", 2 } } };
	seth.vars[VAR_AIM_DEAD] = (ethVars_t) { "Aim at dead player", qfalse, "aimdead", CAT_AIMBOT, qfalse,
		{ { "Off", qfalse }, { "On", qtrue } } };
	seth.vars[VAR_BLOCK_MOUSE] = (ethVars_t) { "Block mouse when aiming", qtrue, "block_mouse", CAT_AIMBOT, qfalse,
		{ { "Off", qfalse }, { "On", qtrue } } };
	...
	seth.vars[VAR_CHAMS] = (ethVars_t) { "Chams", CHAM_QUAKE, "chams", CAT_ESP, qfalse,
		{ { "Off", qfalse }, { "Glow", CHAM_GLOW }, { "Glow only", CHAM_GLOWONLY }, { "Flat", CHAM_FLAT } , { "QuakeIII A", CHAM_QUAKE } , { "QuakeIII B", CHAM_QUAKEB }, { "QuakeIII C", CHAM_QUAKEC }, { "1337 Starr A", CHAM_STARA }, { "1337 Starr B", CHAM_STARB } } };
	...
	// Misc
	seth.vars[VAR_RANDOMNAME] = (ethVars_t) { "Random name", NAME_OFF, "randomname", CAT_MISC, qfalse,
		{ { "Off", NAME_OFF }, { "From other servers", NAME_WORLD }, { "From other players", NAME_PLAYERS } , { "Other players (PB Friendly)", NAME_PLAYERS_SPOOF }} };
	...
	seth.vars[VAR_ENTCAM_PLAYER] = (ethVars_t) { "Player Cam", 0, "playercam", CAT_SPYCAM, qfalse,
		{} };
